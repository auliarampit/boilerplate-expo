...
import SocialLoginButtons from '@/plugins/social-login/components/SocialLoginButtons'
import useSocialAuth, { SocialAuthUser } from '@/plugins/social-login/hooks/useSocialAuth'
...
// Mock dependencies
jest.mock('@/plugins/social-login/hooks/useSocialAuth')
jest.mock('@/i18n')
